      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Job Application', slug: 'templates/job-application', translations: { es: 'Solicitud de Empleo', pt: 'Candidatura de Emprego', 'pt-BR': 'Candidatura de Emprego', zh: '求职申请', 'zh-CN': '求职申请', fr: 'Candidature' } },
          ],
        },
      ],
    }),
