...
import { Layout, Menu, Breadcrumb, Masonry } from '@edadma/petalui'
...
export function LayoutPage() {
    ...
    <div>
      ...
      <Masonry columns={{ xs: 1 }} gap={4}>
        <ExampleSection
          ...
          code={`<Layout className="min-h-[300px]">
  <Layout.Header>Header</Layout.Header>
  <Layout.Content className="p-6">Content</Layout.Content>
  ...
  <Layout.Content className="p-6">Content</Layout.Content>
        ...
        <ExampleSection
          ...
          code={`<Layout className="min-h-[400px]">
  <Layout.Sider width={200}>
    <Menu mode="inline" defaultOpenKeys={['sub1']} selectedKeys={[selected]}>
  ...
  >
    <Menu mode="inline" selectedKeys={['1']}>
      <Menu.Item itemKey="1" icon={<HomeIcon />}>Home</Menu.Item>
      <Menu.Item itemKey="2" icon={<UserIcon />}>Users</Menu.Item>
      <Menu.Item itemKey="3" icon={<FolderIcon />}>Files</Menu.Item>
    </Menu>
  </Layout.Sider>
  <Layout.Content className="p-6">Content</Layout.Content>
</Layout>`}
        ...
        <ExampleSection
          ...
          code={`<Layout className="min-h-[500px]">
  <Layout.Header className="bg-neutral text-neutral-content">
    <div className="font-bold text-xl mr-8">Logo</div>
    <Menu mode="horizontal" selectedKeys={['nav2']} className="flex-1">
  ...
  <Layout className="flex-1">
    <Layout.Sider width={200} className="bg-base-100">
      <Menu mode="inline" defaultOpenKeys={['sub1']} selectedKeys={['1']}>
    ...
    <Layout className="flex-col">
      ...
      <Layout.Content className="m-6 p-6 bg-base-100 rounded-lg">
        Content
      </Layout.Content>
    </Layout>
  </Layout>
