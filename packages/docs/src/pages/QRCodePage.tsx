...
import { QRCode, Button, Masonry } from '@edadma/petalui'
...
import { QRCode } from '@edadma/petalui'
...
export default App`}
        ...
        <ExampleSection
          ...
          code={`import React, { useState } from 'react'
import { QRCode, Input, Button } from '@edadma/petalui'
...
import { QRCode, Button } from '@edadma/petalui'
