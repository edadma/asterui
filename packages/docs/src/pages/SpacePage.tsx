import { Space, Button, Card, Badge, Masonry } from '@edadma/petalui'
...
import { Space, Button } from '@edadma/petalui'
...
export default App`}
        ...
        <ExampleSection
          ...
          code={`import React from 'react'
import { Space, Badge } from '@edadma/petalui'
...
export default App`}
        ...
        <ExampleSection
          ...
          code={`import React from 'react'
import { Space, Card, Button } from '@edadma/petalui'
