import { Indicator, Avatar, Button, Masonry } from '@edadma/petalui'
...
import { Indicator, Avatar } from '@edadma/petalui'
...
export default App`}
        ...
        <ExampleSection
          ...
          code={`import React from 'react'
import { Indicator, Button } from '@edadma/petalui'
...
export default App`}
        ...
        <ExampleSection
          ...
          code={`import React from 'react'
import { Indicator } from '@edadma/petalui'
