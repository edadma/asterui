...
const demos: Record<string, React.ReactNode> = {
  ...
  combined: (
    <Typography>
      ...
      <Paragraph>
        Typography is a fundamental aspect of design that significantly impacts user experience.
        This example demonstrates how various typography elements can work together.
      </Paragraph>

      <Title level={2}>Key Concepts</Title>
      <Paragraph>
        When working with text, consider these important elements:
      </Paragraph>
      <ul className="list-disc list-inside mb-4">
        <li>
          <Text strong>Hierarchy</Text> - Establishing visual importance
        </li>
        <li>
          <Text strong>Readability</Text> - Ensuring content is easy to read
        </li>
        <li>
          <Text strong>Consistency</Text> - Maintaining uniform styling
        </li>
      </ul>

      <Title level={3}>Learn More</Title>
      <Paragraph>
        For more information, check out our <Link href="#">documentation</Link> or{' '}
