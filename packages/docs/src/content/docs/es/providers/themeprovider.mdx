...
| `toggleTheme` | `() => void` | Alternar entre tema claro y oscuro. |
...
- **Soporte Canvas**: Proporciona colores hex para contextos canvas/WebGL a través de la propiedad `colors` (lazy — sin costo a menos que se acceda)
