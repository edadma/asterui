...
import { LoginFormDemo } from '../../../templates/LoginFormDemo'
import LoginFormDemoSource from '../../../templates/LoginFormDemo.tsx?raw'
...
<Example title="Sign In Form" description="Complete login form with email validation, remember me, and links." source={LoginFormDemoSource} fn="LoginFormDemo">
