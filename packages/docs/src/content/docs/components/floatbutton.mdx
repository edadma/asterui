...
The FloatButton component supports the `data-testid` prop for e2e testing. Child elements receive suffixed test IDs:

```tsx
<FloatButton.Group data-testid="actions" trigger="click">
...
|---------|---------|
| Container | `actions` |
| Trigger button | `actions-trigger` |
| Main action | `actions-main-action` |
| Close icon | `actions-close` |
| Badge | `actions-badge` |
| Tooltip | `actions-tooltip` |
| Indicator | `actions-indicator` |
