...
The Autocomplete component supports the `data-testid` prop for e2e testing. Child elements receive suffixed test IDs:

```tsx
<Autocomplete data-testid="search" options={options} />
```
