...
The Input component supports the `data-testid` prop for e2e testing. When using prefix, suffix, addons, or allowClear, child elements receive suffixed test IDs:
...
| Addon before | `search-addon-before` |
| Addon after | `search-addon-after` |
