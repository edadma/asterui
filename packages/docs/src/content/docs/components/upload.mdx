...
The Upload component supports the `data-testid` prop for e2e testing. Child elements receive suffixed test IDs:

```tsx
<Upload data-testid="avatar-upload">
...
| File input | `avatar-upload-input` |
| Dropzone | `avatar-upload-dropzone` |
