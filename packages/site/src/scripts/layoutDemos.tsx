...
import { Layout, Menu, Button, Space } from 'asterui'
    ...
    <Layout className="min-h-[300px] w-full border border-base-300 rounded-lg overflow-hidden">
      ...
      <Layout className="flex-1">
        <Layout.Sider width={160} className="p-2">
          <Menu size="sm">
            <Menu.Item itemKey="home" icon={DashboardIcon}>Home</Menu.Item>
            <Menu.Item itemKey="about" icon={UsersIcon}>About</Menu.Item>
            <Menu.Item itemKey="contact" icon={SettingsIcon}>Contact</Menu.Item>
          </Menu>
        </Layout.Sider>
        <Layout.Content className="bg-base-200 p-6">
          <div className="bg-base-100 p-4 rounded-lg">
...
// Interactive Collapsible Sider Demo
...
demos['collapsible'] = <CollapsibleDemo />

// Interactive Menu Navigation Demo
const MenuNavigationDemo: React.FC = () => {
...
demos['menu-navigation'] = <MenuNavigationDemo />

// Submenu Navigation Demo
const SubmenuNavigationDemo: React.FC = () => {
...
demos['submenu'] = <SubmenuNavigationDemo />
