...
const demos: Record<string, React.ReactNode> = {
  ...
  icons: (
    <div className="flex gap-2 flex-wrap">
      <Tag color="primary" icon={<DocumentIcon />}>
        Document
      </Tag>
      <Tag color="success" icon={<CheckIcon />}>
        Done
      </Tag>
      <Tag color="error" icon={<CloseIcon />}>
        Failed
      </Tag>
    </div>
  ),
  ...
  'checkable-icons': (
    <div className="flex gap-2 flex-wrap">
      <CheckableTag icon={<EducationIcon />}>Education</CheckableTag>
      <CheckableTag checked icon={<FinanceIcon />}>
        Finance
      </CheckableTag>
      <CheckableTag icon={<TrendingIcon />}>Trending</CheckableTag>
    </div>
  ),
  'use-cases': (
